...
//   视频广告
    public static final String  AD_VIDDO="COIN_VIDEO_EXIT";
//    卡券广告
    public static final String  AD_CARD="COIN_CARD_GIVE";
//    banner 广告
    public static final String  AD_BANNER="COIN_BANNER_EXIT";
//    开屏广告
